...
def load_entity_type():
    type2id = dict()
    lines = [s for s in codecs.open("../data/type/entity2typeid.txt", "r", encoding="UTF-8").readlines()]
...
def init():
    ...
    for key, value in train_hrt_bags.items():
        ...
        train_ht_type.append([type2id[e1] if e1 in type2id.keys() else 0, type2id[e2] if e2 in type2id.keys() else 0])
    ...
    for key, value in test_hrt_bags.items():
        ...
        test_ht_type.append([type2id[e1] if e1 in type2id.keys() else 0, type2id[e2] if e2 in type2id.keys() else 0])
...
def test_wrong_data():
    ...
    non = []
    nons = []
    lines = [s for s in codecs.open("../data/case/wrong.txt", "r", encoding="UTF-8").readlines()]
